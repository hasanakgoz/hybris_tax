...
public class DefaultTaxcalculationgenericService implements TaxcalculationgenericService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTaxcalculationgenericService.class);
	...
	{
		return DefaultTaxcalculationgenericService.class.getResourceAsStream("/taxcalculationgeneric/sap-hybris-platform.png");
	}
