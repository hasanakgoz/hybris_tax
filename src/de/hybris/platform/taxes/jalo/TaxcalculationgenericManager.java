 ...
 */
package de.hybris.platform.taxes.jalo;
...
/**
 * This is the extension manager of the Taxcalculationgeneric extension.
 */
public class TaxcalculationgenericManager extends GeneratedTaxcalculationgenericManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TaxcalculationgenericManager.class);
	 ...
	 */
	public static TaxcalculationgenericManager getInstance()
	{
		return (TaxcalculationgenericManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TaxcalculationgenericConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TaxcalculationgenericManager() // NOPMD 
	{
		LOG.debug("constructor of TaxcalculationgenericManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TaxcalculationgenericManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TaxcalculationgenericManager called, current tenant: {}", getTenant().getTenantID());
	}
